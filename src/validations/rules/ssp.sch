    ...
    <sch:pattern
        ...
        <sch:rule
            ...
            <sch:assert
                ...
                role="error"
                test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name = 'users-internal']">A FedRAMP SSP must specify the number of current
                internal users.</sch:assert>
            <sch:assert
                diagnostics="has-users-external-diagnostic"
                doc:guide-reference="Guide to OSCAL-based FedRAMP System Security Plans §4.19"
                id="has-users-external"
                role="error"
                test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name = 'users-external']">A FedRAMP SSP must specify the number of current
                external users.</sch:assert>
            <sch:assert
                diagnostics="has-users-internal-future-diagnostic"
                doc:guide-reference="Guide to OSCAL-based FedRAMP System Security Plans §4.19"
                id="has-users-internal-future"
                role="error"
                test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name = 'users-internal-future']">A FedRAMP SSP must specify the number of
                future internal users.</sch:assert>
            <sch:assert
                diagnostics="has-users-external-future-diagnostic"
                doc:guide-reference="Guide to OSCAL-based FedRAMP System Security Plans §4.19"
                id="has-users-external-future"
                role="error"
                test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name = 'users-external-future']">A FedRAMP SSP must specify the number of
                future external users.</sch:assert>
        </sch:rule>
    </sch:pattern>

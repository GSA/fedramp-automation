...
<sch:schema
    ...
    <xsl:function
        ...
        <xsl:choose>
            ...
            <xsl:when
                test="$value-set/f:allowed-values/@allow-other = 'no' and $value = $values" />
            <xsl:otherwise>
                <xsl:value-of
                    select="$values"
                    separator=", " />
    ...
    <sch:pattern>
        ...
        <sch:rule
            ...
            <sch:report
                ...
                role="information"
                test="exists($implemented)">[Section C Check 2] This SSP has implemented a statement for each of the following lettered response
                points for required controls: <sch:value-of
        ...
        <sch:rule
            ...
            <sch:let
                ...
                value="@media-type" />
            <sch:assert
                diagnostics="resource-base64-available-filenamne-diagnostic"
                doc:organizational-id="section-b.?????"
    ...
    <sch:pattern>
        ...
        <sch:rule
            ...
            <sch:assert
                ...
                role="error"
                test="matches(normalize-space(), '^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/][AQgw]==|[A-Za-z0-9+/]{2}[AEIMQUYcgkosw048]=)?$')">A base64
    ...
    <sch:pattern>
        ...
        <sch:rule
            ...
            <sch:assert
                ...
                OSCAL SSP must have the FedRAMP Master Acronym and Glossary attached.</sch:assert>
            <sch:assert
                diagnostics="has-fedramp-citations-diagnostic"
                doc:attachment="§15 Attachment 12"
                id="has-fedramp-citations"
                role="error"
                test="oscal:resource[oscal:prop[@ns = 'https://fedramp.gov/ns/oscal' and @name = 'type' and @value = 'fedramp-citations']]"> [Section
                B Check 3.12] A FedRAMP OSCAL SSP must have the FedRAMP Applicable Laws and Regulations attached.</sch:assert>
            <sch:assert
            ...
            <sch:assert
                ...
                id="has-user-guide"
                role="error"
                test="oscal:resource[oscal:prop[@ns = 'https://fedramp.gov/ns/oscal' and @name = 'type' and @value = 'user-guide']]">[Section B Check
                3.2] A FedRAMP OSCAL SSP must have a User Guide attached.</sch:assert>
            <sch:assert
                diagnostics="has-rules-of-behavior-diagnostic"
                doc:attachment="§15 Attachment 5"
                id="has-rules-of-behavior"
                role="error"
                test="oscal:resource[oscal:prop[@ns = 'https://fedramp.gov/ns/oscal' and @name = 'type' and @value = 'rules-of-behavior']]"> [Section
                B Check 3.5] A FedRAMP OSCAL SSP must have Rules of Behavior.</sch:assert>
            <sch:assert
    ...
    <sch:pattern>
        ...
        <sch:rule
            ...
            <sch:assert
                ...
                id="has-policy-link"
                role="error"
                test="descendant::oscal:by-component/oscal:link[@rel = 'policy']">[Section B Check 3.1] A FedRAMP SSP must incorporate a policy
            ...
            <sch:assert
                ...
                test="
                    every $ref in $policy-hrefs
                        satisfies exists(//oscal:resource[oscal:prop[@name = 'type' and @value = 'policy']][@uuid = $ref])">[Section B
            ...
            <sch:assert
                ...
                role="error"
                test="descendant::oscal:by-component/oscal:link[@rel = 'procedure']">[Section B Check 3.1] A FedRAMP SSP must incorporate a procedure
                document for each of the 17 NIST SP 800-54 Revision 4 control families.</sch:assert>
            <sch:let
            ...
            <sch:assert
                ...
                test="
                    ...
                    every $ref in $procedure-hrefs
                        satisfies exists(//oscal:resource[oscal:prop[@name = 'type' and @value = 'procedure']][@uuid = $ref])">[Section
    ...
    <sch:pattern>
        ...
        <sch:rule
            ...
            <sch:assert
                ...
                role="error"
                test="/oscal:system-security-plan/oscal:metadata/oscal:role[@id = 'privacy-poc']">[Section B Check 3.4] A FedRAMP OSCAL SSP must
            ...
            <sch:assert
                ...
                role="error"
                test="/oscal:system-security-plan/oscal:metadata/oscal:responsible-party[@role-id = 'privacy-poc']">[Section B Check 3.4] A FedRAMP
            ...
            <sch:assert
                ...
                id="has-privacy-poc"
                role="error"
                test="/oscal:system-security-plan/oscal:metadata/oscal:party[@uuid = $poc-uuid]">[Section B Check 3.4] A FedRAMP OSCAL SSP must define
    ...
    <sch:pattern>
        ...
        <sch:rule
            ...
            <sch:assert
                ...
                role="error"
                test="oscal:prop[@ns = 'https://fedramp.gov/ns/oscal' and @class = 'pta' and @name = 'pta-1']">[Section B Check 3.4] A FedRAMP OSCAL
                SSP must have Privacy Threshold Analysis (PTA)/Privacy Impact Analysis (PIA) qualifying question #1.</sch:assert>
            <sch:assert
                diagnostics="has-pta-question-2-diagnostic"
                id="has-pta-question-2"
                role="error"
                test="oscal:prop[@ns = 'https://fedramp.gov/ns/oscal' and @class = 'pta' and @name = 'pta-2']">[Section B Check 3.4] A FedRAMP OSCAL
                SSP must have Privacy Threshold Analysis (PTA)/Privacy Impact Analysis (PIA) qualifying question #2.</sch:assert>
            <sch:assert
                diagnostics="has-pta-question-3-diagnostic"
                id="has-pta-question-3"
                role="error"
                test="oscal:prop[@ns = 'https://fedramp.gov/ns/oscal' and @class = 'pta' and @name = 'pta-3']">[Section B Check 3.4] A FedRAMP OSCAL
                SSP must have Privacy Threshold Analysis (PTA)/Privacy Impact Analysis (PIA) qualifying question #3.</sch:assert>
            <sch:assert
                diagnostics="has-pta-question-4-diagnostic"
                id="has-pta-question-4"
                role="error"
                test="oscal:prop[@ns = 'https://fedramp.gov/ns/oscal' and @class = 'pta' and @name = 'pta-4']">[Section B Check 3.4] A FedRAMP OSCAL
                SSP must have Privacy Threshold Analysis (PTA)/Privacy Impact Analysis (PIA) qualifying question #4.</sch:assert>
            <sch:assert
                ...
                test="
                    every $name in ('pta-1', 'pta-2', 'pta-3', 'pta-4')
                        satisfies exists(oscal:prop[@ns = 'https://fedramp.gov/ns/oscal' and @class = 'pta' and @name = $name])">[Section
                B Check 3.4] A FedRAMP OSCAL SSP must have all four PTA questions.</sch:assert>
            <sch:assert
                ...
                test="
                    not(some $name in ('pta-1', 'pta-2', 'pta-3', 'pta-4')
                        satisfies exists(oscal:prop[@ns = 'https://fedramp.gov/ns/oscal' and @class = 'pta' and @name = $name][2]))">[Section
                B Check 3.4] A FedRAMP OSCAL SSP must have no duplicate PTA questions.</sch:assert>
        </sch:rule>
        <sch:rule
            context="/oscal:system-security-plan/oscal:system-characteristics/oscal:system-information"
            see="DRAFT Guide to OSCAL-based FedRAMP System Security Plans page 51">
    ...
    <sch:pattern
        ...
        <sch:rule
            ...
            <sch:assert
                ...
                role="error"
                test="oscal:component[@type = 'validation'] or oscal:inventory-item[@type = 'validation']">A FedRAMP OSCAL SSP must incorporate one or
                more FIPS 140 validated modules.</sch:assert>
        </sch:rule>
        <sch:rule
            context="oscal:component[@type = 'validation'] | oscal:inventory-item[@type = 'validation']">
            <sch:assert
        ...
        <sch:rule
            ...
            <sch:assert
                ...
                role="error"
                test="tokenize(@href, '/')[last()] = preceding-sibling::oscal:prop[@name = 'validation-reference']/@value">A validation-details link
    ...
    <sch:pattern
        ...
        <sch:rule
            ...
            <sch:assert
                ...
                role="error"
                test=". = $fips-199-levels">A FedRAMP OSCAL SSP information-type confidentiality-, integrity-, or availability-impact base or select
    ...
    <sch:pattern
        ...
        <sch:rule
            ...
            <sch:assert
                ...
                role="error"
                test="oscal:prop[@ns = 'https://fedramp.gov/ns/oscal' and @class = 'security-eauth' and @name = 'security-eauth-level']"> [Section B
                Check 3.3] A FedRAMP OSCAL SSP must have a Digital Identity Determination property.</sch:assert>
            <sch:assert
            ...
            <sch:assert
                ...
                role="information"
                test="oscal:prop[@name = 'authenticator-assurance-level']">[Section B Check 3.3] A FedRAMP OSCAL SSP may have a Digital Identity
                Determination authenticator-assurance-level property.</sch:assert>
            <sch:assert
        ...
        <sch:rule
            ...
            role="error">
            <sch:let
                name="security-eauth-levels"
                value="('1', '2', '3')" />
            <sch:assert
                diagnostics="has-allowed-security-eauth-level-diagnostic"
                id="has-allowed-security-eauth-level"
                role="error"
                test="@value = $security-eauth-levels">[Section B Check 3.3] A FedRAMP OSCAL SSP must have a Digital Identity Determination property
        ...
        <sch:rule
            ...
            <sch:assert
                ...
                role="error"
                test="@value = $authenticator-assurance-levels">[Section B Check 3.3] A FedRAMP OSCAL SSP should have an allowed Digital Identity
                Determination authenticator-assurance-level property.</sch:assert>
        </sch:rule>
        <sch:rule
            ...
            <sch:assert
                ...
                role="error"
                test="@value = $federation-assurance-levels">[Section B Check 3.3] A FedRAMP OSCAL SSP should have an allowed Digital Identity
                Determination federation-assurance-level property.</sch:assert>
        </sch:rule>
    </sch:pattern>
    <sch:pattern>
        ...
        <sch:rule
            ...
            <sch:assert
                ...
                role="error"
                test="not(oscal:prop[(: @ns = 'https://fedramp.gov/ns/oscal' and :)@name = 'vendor-name'][2])">"infrastructure" inventory-item must
                have only one vendor-name property.</sch:assert>
            ...
            <sch:assert
                ...
                role="error"
                test="oscal:prop[(: @ns = 'https://fedramp.gov/ns/oscal' and :)@name = 'hardware-model']">"infrastructure" inventory-item must have a
            ...
            <sch:assert
                ...
                role="error"
                test="not(oscal:prop[(: @ns = 'https://fedramp.gov/ns/oscal' and :)@name = 'hardware-model'][2])">"infrastructure" inventory-item must
                have only one hardware-model property.</sch:assert>
            <sch:assert
            ...
            <sch:assert
                ...
                role="error"
                test="not(oscal:prop[@name = 'is-scanned'][2])">"infrastructure" inventory-item must have only one is-scanned property.</sch:assert>
        ...
        <sch:rule
            ...
            <sch:assert
                ...
                role="error"
                test="oscal:prop[@name = 'software-name']">"software or database" inventory-item must have a software-name property.</sch:assert>
            <sch:assert
            ...
            <sch:assert
                ...
                role="error"
                test="not(oscal:prop[@name = 'function'][2])">"software or database" inventory-item must have one function property.</sch:assert>
        </sch:rule>
    ...
    <sch:pattern>
        <sch:rule
            ...
            <sch:assert
                diagnostics="has-system-component-diagnostic"
    ...
    <sch:pattern
        ...
        <sch:rule
            ...
            <sch:assert
                ...
                role="error"
                test="//oscal:responsible-party[@role-id = current()/@id]">One or more responsible parties must be defined for each role.</sch:assert>
        </sch:rule>
        <sch:rule
    ...
    <sch:pattern
        ...
        <sch:rule
            ...
            <sch:assert
                diagnostics="distinct-responsible-role-has-user-diagnostic"
    ...
    <sch:pattern
        ...
        <sch:rule
            ...
            <sch:assert
                diagnostics="user-has-privilege-type-diagnostic"
        ...
        <sch:rule
            ...
            <sch:report
                role="information"
                test="true()">User types are <sch:value-of
                    select="string-join($user-types, ', ')" />.</sch:report>
            <sch:assert
        ...
        <sch:rule
            context="oscal:user/oscal:prop[@name = 'privilege-type']">
            <sch:let
                name="user-privilege-types"
                value="$fedramp-values//fedramp:value-set[@name = 'user-privilege']//fedramp:enum/@value" />
            <sch:report
                role="information"
                test="true()">Privilege types are <sch:value-of
                    select="string-join($user-privilege-types, ', ')" />.</sch:report>
            <sch:assert
                diagnostics="user-privilege-type-has-allowed-value-diagnostic"
        ...
        <sch:rule
            ...
            <sch:report
                role="information"
                test="true()">Sensitivity levels are <sch:value-of
                    select="string-join($user-sensitivity-levels, ', ')" />.</sch:report>
            <sch:assert
    ...
    <sch:diagnostics>
        <sch:diagnostic
            ...
            id="no-registry-values-diagnostic">The registry values at the path ' <sch:value-of
        ...
        <sch:diagnostic
            ...
            doc:context="/o:system-security-plan"
            id="no-security-sensitivity-level-diagnostic">[Section C Check 1.a] No sensitivity level was found As a result, no more validation
            processing can occur.</sch:diagnostic>
        <sch:diagnostic
            doc:assertion="invalid-security-sensitivity-level"
            doc:context="/o:system-security-plan"
            id="invalid-security-sensitivity-level-diagnostic">[Section C Check 1.a] <sch:value-of
        ...
        <sch:diagnostic
            ...
            id="incomplete-core-implemented-requirements-diagnostic">[Section C Check 3] This SSP has not implemented the most important <sch:value-of
        ...
        <sch:diagnostic
            ...
            doc:context="/o:system-security-plan/o:control-implementation"
            id="incomplete-all-implemented-requirements-diagnostic">[Section C Check 2] This SSP has not implemented <sch:value-of
        ...
        <sch:diagnostic
            ...
            doc:context="/o:system-security-plan/o:control-implementation"
            id="extraneous-implemented-requirements-diagnostic">[Section C Check 2] This SSP has implemented <sch:value-of
        ...
        <sch:diagnostic
            ...
            id="invalid-implementation-status-diagnostic">[Section C Check 2] Invalid status ' <sch:value-of
        ...
        <sch:diagnostic
            ...
            doc:context="/o:system-security-plan/o:control-implementation/o:implemented-requirement"
            id="missing-response-points-diagnostic">[Section C Check 2] This SSP has not implemented a statement for each of the following lettered
            response points for required controls: <sch:value-of
        ...
        <sch:diagnostic
            ...
            id="missing-response-components-diagnostic">[Section D Checks] Response statements for <sch:value-of
        ...
        <sch:diagnostic
            ...
            id="extraneous-response-description-diagnostic">[Section D Checks] Response statement <sch:value-of
        ...
        <sch:diagnostic
            ...
            id="extraneous-response-remarks-diagnostic">[Section D Checks] Response statement <sch:value-of
        ...
        <sch:diagnostic
            ...
            id="invalid-component-match-diagnostic">[Section D Checks] Response statement <sch:value-of
        ...
        <sch:diagnostic
            ...
            doc:context="/o:system-security-plan/o:control-implementation/o:implemented-requirement/o:statement/o:by-component"
            id="missing-component-description-diagnostic">[Section D Checks] Response statement <sch:value-of
        ...
        <sch:diagnostic
            ...
            id="incomplete-response-description-diagnostic">[Section D Checks] Response statement component description for <sch:value-of
        ...
        <sch:diagnostic
            ...
            id="incomplete-response-remarks-diagnostic">[Section D Checks] Response statement component remarks for <sch:value-of
                select="../../@statement-id" />is too short with <sch:value-of
        ...
        <sch:diagnostic
            ...
            id="incorrect-role-association-diagnostic">[Section C Check 2] This SSP has defined a responsible party with <sch:value-of
        ...
        <sch:diagnostic
            ...
            doc:context="/o:system-security-plan/o:metadata"
            id="incorrect-party-association-diagnostic">[Section C Check 2] This SSP has defined a responsible party with <sch:value-of
        ...
        <sch:diagnostic
            ...
            id="resource-rlink-required-diagnostic">This SSP references back-matter resource: <sch:value-of
                select="./@href" />.</sch:diagnostic>
        <sch:diagnostic
            doc:assertion="resource-base64-available-filenamne"
        ...
        <sch:diagnostic
            doc:assertion="has-system-component"
            doc:context="oscal:system-implementation"
        ...
        <sch:diagnostic
            doc:assertion="user-has-privilege-type"
            doc:context="oscal:user"
        ...
        <sch:diagnostic
            doc:assertion="user-privilege-type-has-allowed-value"
        ...
        <sch:diagnostic
            ...
            id="user-sensitivity-level-has-allowed-value-diagnostic">User sensitivity level property has an allowed value.</sch:diagnostic>
        <sch:diagnostic

---
title: Overview
description: Overview of manipulating Open Security Controls Assessment Language (OSCAL)-based FedRAMP System Security Plan (SSP) content
toc:
   enabled: true
...
<img style="float: right;" src="refer-to.png">
